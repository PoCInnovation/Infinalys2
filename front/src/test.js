...
class CandleStickChartWithBollingerBandOverlay extends React.Component {
	render() {
		...
		const calculatedData = ema20(sma20(ema50(macdCalculator(smaVolume50(bb(initial_data)))))); // const calculatedData = ema20(sma20(ema50(smaVolume50(bb(initialData)))));
			...
			>
				...
				>
					...
					<CandlestickSeries fill={(d) =>
							d.open === d.high ? "rgb(255,255,0)" : d.close > d.open ? "rgb(0,166,81)" : "rgb(204,36,36)" }
						/>
					{boolinger}
					{ema_20}
					{ema_20_cord}
